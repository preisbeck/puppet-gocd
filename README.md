...
1. [Setup - The basics of getting started with gocd](#setup)
    * [What gocd affects](#what-gocd-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with gocd](#beginning-with-gocd)
